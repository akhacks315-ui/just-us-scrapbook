...
const timeline = [
 ...
 {date:"17 FEB 2026 · AFTERNOON",title:"Our first date.",text:"Later that same day, we went to Mantri Square Mall for our first date. A day that will always have a special place in my heart."},
 {date:"BEFORE US",title:"I almost forgot you.",text:"We first met through a common friend after college. I didn't notice anything that day — I even forgot your name. Then I went home for a week."},
 {date:"15–20 DAYS LATER",title:"Then I started noticing you.",text:"I kept seeing you around college. We started having those little eye contacts, and I kept feeling like I knew you from somewhere. One day I finally walked up and asked, 'Do I know you?' — and somehow I even got your name wrong."},
 {date:"AFTER THAT",title:"And then there was us.",text:"That awkward question started our conversations. We began texting, slowly became each other's comfortable person, and started collecting little memories together — ISKCON visits, random ice creams, Corner House and all the ordinary moments that became special because they were with you."},
 {date:"TODAY",title:"Every moment with you matters.",text:"Every moment I spend with you is important to me. This is only the beginning, and I want this little world of ours to keep growing with us."}
];

const letters = [
 {tag:"LETTER 01",title:"Things I love about you",text:"Neha, I love your cuteness, your eyes, your honesty, your caring nature and your innocence. But honestly, the more time I spend with you, the more reasons I find. You have this way of becoming my favourite part of an ordinary day."},
